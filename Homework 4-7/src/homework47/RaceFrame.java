...
public class RaceFrame extends javax.swing.JFrame {
    ...
    private final RaceMannager myRaceMannager = new RaceMannager();
    ...
    public RaceFrame() {
        initComponents();
        raceTextArea.append(myRaceMannager.getResult());
        int index = 1;
        while (!myRaceMannager.move()) {
            raceTextArea.append(String.valueOf(index) + "\n");
            raceTextArea.append(myRaceMannager.getResult());
            index++;
        }
        raceTextArea.append(myRaceMannager.getResult());
    ...
    private void initComponents() {
        ...
        raceTextArea.setForeground(new java.awt.Color(255, 153, 0));
