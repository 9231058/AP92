...
public class QueueFrame extends javax.swing.JFrame {
    ...
    public QueueFrame() {
        ...
        jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTextField1.getText() != null) {
                    myQueue.add(jTextField1.getText());
                    jTextField1.selectAll();
                }
            }
        });
        jButton2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    jTextArea1.append(myQueue.poll().toString() + "\n");
                } catch (IndexOutOfBoundsException exception) {
                    JOptionPane.showMessageDialog(QueueFrame.this,"The Queue is empty","Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
